...
private let reusueIdentifier = "ActionSheetCell"
...
class ActionSheetLauncher: NSObject {
    ...
    func configureTableView() {
        ...
        tableView.register(ActionSheetCell.self, forCellReuseIdentifier: reusueIdentifier)
...
extension ActionSheetLauncher: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: reusueIdentifier, for: indexPath) as! ActionSheetCell
